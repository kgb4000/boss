    ...
    <>
      ...
      <section>
        <div className="container">
          ...
          <p>
            We’re delivering year-round and multi-year programming around our 6
            BOSS Pillars including STEAM focused academic enrichment, career
          ...
          <ul>
            ...
            <li>
              ...
              Hackathon for Good, Safe Encounter App. Click here for short video
              demonstration of app.
            </li>
            <li>
              2019 Hustle N’ Code Hackathon participant around solving community
              issues through code.
            </li>
            <li>
              Participated in 2-day Launch To Success STEM Workshop presented by
              The Aerospace Corporation and meant to inspire the next generation
              of engineers and scientists by immersing a group of Southern CA
              students in the diverse culture of Aerospace and exposing them to
              the various careers of our employee volunteers. Click here for a
              short video of the workshop
            </li>
            <li>
              Partnership with Microsoft which provides year-round opportunities
              to learn coding, build video games, etc.
            </li>
            <li>
          ...
          <p>
            Click on the video to learn how we start the “process” with a 2-week
      ...
      <section>
        <div className="container">
          ...
          <ul>
            <li>
              Long-term. We follow the same group of boys from middle school all
              the way to and through college, providing a comprehensive program
            ...
            <li>
              ...
              skills and networking and professional development, we support the
              well-being of boys through ongoing social/emotional support
            </li>
            <li>
