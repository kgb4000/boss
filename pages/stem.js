    ...
    <>
      ...
      <StemPage>
        <div className="container">
          <h2>Why STEM?</h2>
          <p>
            Science, Technology, Engineering, and Math (STEM) occupations are in
            high demand and continue to be among the fastest growing within the
            21st century workforce across the US economy (BLS, 2017).
          </p>
          <p>
            ...
            imperative to ensure students of color are equipped to engage in the
            STEM sector at parity with their peers.
          </p>
          <p>
            Eliminating the barriers facing Black, Latinx, and Native American
            students who have the desire to enter STEM and computing professions
            has the potential to meet the projected demand for STEM workers in
            our future workforce, while broadening the economic opportunities of
            underrepresented communities of color. Moreover, by investing in
            youth of color to enter and persist in STEM and computing
            occupations, they develop the skills to engage in the modern
            workforce while being empowered to leverage their lived experiences
            to solve the most pressing problems facing society (Bobb, 2016).
          </p>
          <div className="btn">
            <Link href="/register">
              <a>
          ...
          <ul>
            ...
            <li>
              The STEM jobs market grew 45% in 2018. Fifteen (15) of the twenty
              (20) fastest growing occupations require significant mathematics
              or science preparation.
            </li>
            <li>
              People in STEM fields can expect to earn 26% more money on average
              and be less likely to experience job loss.
            </li>
            <li>
              92% of boys and 97% of girls lose interest in STEM if not engaged
              by the 5 th grade (Dr. Kenneth Wesson, Educational Consultant:
              Neuroscience).
            </li>
            <li>
            ...
            <li>
              Out of 65 countries, American students score 17 th in science and
              25 th in math ability (The U.S. Organization of Economic
              Cooperation and Development).
            </li>
            <li>
              Only 6% of high school seniors will get a bachelor&#39;s degree in
              a STEM field.
            </li>
            ...
            <li>
              ...
              half of undergraduates that declare and intent to major in a STEM
              field complete a degree in one of those subjects.
            </li>
            <li>
          ...
          <p>
            ...
            STEM Portal will provide the resources and supports to help prepare
            BIPOC students to critically analyze problems facing their
          ...
          <p>
            <span>E</span> Engineering is the method of applying scientific and
            mathematical knowledge to human // activity
          </p>
          <p>
            <span>M</span> All of STEM is underpinned by Mathematics, which
            includes numeracy, and equips us with the skills and approaches we
            need to interpret and analyze information, simplify and solve
            problems, assess risk and make informed decisions. Mathematics and
            Numeracy develop essential skills and capabilities for life,
            participation in society and in all jobs, careers and occupations.
            As well as providing the foundations for STEM, the study and
            application of mathematics is a vast and critical discipline in
            itself with far-reaching implications and value.
          </p>
          <p>
