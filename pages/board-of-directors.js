            ...
            <BoardMembers>
              <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    Before establishing the Institute, Everett was a principal
                    of Entertainment & Sports Plus (“ESP”), a Southern
                  ...
                  <p>
                    ...
                    Hall of Fame. Everett was the first Black attorney/agent to
                    represent multiple 1st round draft picks in the same NFL
                    draft (twice); 1st round draft picks in both the NBA and the
                    NFL in the same year (twice); 1st round draft picks in 5
              ...
              <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    Former college athlete. Vice President of Officiating,
                    Pac-12 Conference. Former VP of Officiating, National
                    Football League; Director-Human Resources North America,
                    Saint-Gobain Performance Plastics; General Manager,
                    Corporate Diversity, U.S. Steel; Vice President, Ranpak;
                    Lieutenant Colonel – Adjutant General’s Corps, U.S. Army.
                    Board Member, Murtis Taylor Human Services Center. B.S.
                    Engineering, U.S. Military at West Point; M.S. Operational
                    Research, Weatherhead School of Management at Case-Western
                    Reserve University.
                  </p>
                </div>
              </div>
              <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    ...
                    management, including global staffing matters and the
              ...
              <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    ...
                    supporting the development of organizational
                    infrastructures, which support advancement by leveraging
                    business analytics and research-based best practices
                    resulting in collaborative, results driven, organizational
                    strategies for the C-suite by developing and implementing
                    initiatives focused on sustainable growth and operational
                    excellence.
                  </p>
                </div>
              </div>
              ...
              <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    A former ASU standout football player and former client of
                    our founder. Robert has worked in various financial
                    professional roles for the past 14 years and he is currently
                    Divisional Vice President at American International Group
                    (AIG).
                  </p>
                </div>
              </div>
              ...
              {/* <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    ...
                    Publications include the Handbook on Urban Education (with
                    H. Richard Milner), the Encyclopedia of African American
                    Education and Going to School: The African American
                    Experience. Editor (19 years) of Urban Education Journal,
                    for 19 years.
                  </p>
                  <p>
                    Member editorial boards of the Journal of Negro Education
                    and Educational Researcher. Member, AERA Journals
                    Publication Committee. B.A., Economics, Oberlin College;
                    M.Ed., Elementary Education Curriculum and instruction
                    (Cleveland State University), MA, Educational Administration
                    and Policy Analysis, Stanford, Ph.D., Educational
              ...
              <div className="board-member">
                ...
                <div className="info">
                  ...
                  <p>
                    ...
                    University and Florida A&M University. CEO (2001-03),
                    National Association for Equal Opportunity in Higher
                    Education. B.A., Magna Cum Laude, Physical Chemistry,
                    Florida A&M University; Ph.D., Physical Chemistry,
